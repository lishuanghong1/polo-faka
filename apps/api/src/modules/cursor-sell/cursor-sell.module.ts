...
@Module({
  ...
  providers: [CursorSellService, CursorSellCatalogService, CursorSellFulfilService, CursorSellCron],
  exports: [CursorSellService, CursorSellCatalogService, CursorSellFulfilService],
})
