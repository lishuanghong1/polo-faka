...
const groups = [
  {
    ...
    items: [
      ...
      { to: '/admin/points', icon: 'M12 3l2.6 5.3 5.9.9-4.2 4.1 1 5.8L12 16.3 6.7 19l1-5.8-4.2-4.1 5.9-.9L12 3z', label: '积分' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/account-vault', icon: 'M4 7a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V7zm0 4h16M9 15h2', label: '账号库' },
