...
const ROUTE_TITLES: Record<string, string> = {
  ...
  'admin-account-vault': '账号库',
  'admin-recycle': '回收管理',
  'admin-desktop-files': '桌面安装包',
  'admin-txt': 'TXT 文本库',
  'admin-settings': '站点设置',
  'admin-audit': '审计日志',
  'admin-abuse': 'IP 黑名单',
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'account-vault', name: 'admin-account-vault', component: () => import('@/pages/admin/AccountVault.vue') },
      ...
      { path: 'desktop-files', name: 'admin-desktop-files', component: () => import('@/pages/admin/DesktopFiles.vue') },
      { path: 'txt', name: 'admin-txt', component: () => import('@/pages/admin/TxtDocs.vue') },
