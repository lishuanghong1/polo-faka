...
<template>
  <section class="max-w-3xl mx-auto px-4 py-8">
    <header class="text-center mb-6">
      <h1 class="text-2xl md:text-3xl font-bold text-ink-900">下载 Polo Ai 桌面工具</h1>
      <p class="mt-2 text-sm text-ink-500 leading-relaxed">
        Polo Ai：粘贴卡密一键写入 Cursor · 多账号管理 · 实时查用量 · 号池自动换号<br />
...
sudo xattr -rd com.apple.quarantine "/Applications/Polo Ai.app"
          </code>
        </div>
        <div>
        ...
        <div>
          ...
          <p>Windows：控制面板 → 程序和功能 → 卸载 Polo Ai<br/>
